  ...
  <div>
    <el-card class="box-card bg-purple">
      <div slot="header" class="clearfix">
        <span>Documento de Donacion editado</span>
      </div>
      <div>
...
export default {
  ...
  mounted() {
    console.log(
      "Recuperacion de datos desde DonationDocuments: ",
  ...
  created() {
    var app = this;
    axios
      .post("/api/donationDocuments/edit", {
  ...
  methods: {
    ...
    Exit() {
      ...
      this.$notify.info({
        ...
        message: "No se hizo cambios al Documento de donación",
        duration: 0
      });
    },
    saveAsset() {
      var app = this;
      axios
        .post("/api/donationDocuments/store", this.editForm)
        .then(response => {
