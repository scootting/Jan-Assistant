...
<div>
    <el-container>
        ...
        -->
            ...
            <el-menu default-active="2" class="el-menu-vertical-demo" background-color="#212120" text-color="#faebd7" active-text-color="#faebd7" style="border-right: 0 !important">
                <template v-for="(option, index) in options">
                  ...
                  option.title.trim()
                        ...
                        <el-menu-item-group v-for="(group, g_index) in option.groups" :key="g_index" :title="group.title.trim()">
            ...
            <el-header style="text-align: right; background-color: #F4F3EF">
                ...
                <el-dropdown size="medium">
                    ...
                    <el-dropdown-menu slot="dropdown">
                        <el-dropdown-item icon="el-icon-user" @click.native="initToShowUser">mi perfil</el-dropdown-item>
    ...
    <el-dialog title="gestion" :visible.sync="centerDialogVisible" width="30%" center>
        <el-form>
            <el-form-item label="seleccione la gestion">
                <el-select v-model="yearSelected" placeholder="por favor seleccione una gestion" value-key="gestion">
                    <el-option v-for="item in years" :label="item.gestion" :value="item.ff_gestiones_usuario" :key="item.ff_gestiones_usuario"></el-option>
                </el-select>
            </el-form-item>
        </el-form>
