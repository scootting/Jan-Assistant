            ...
            <el-table v-loading="loading" :data="people" style="width: 100%">
                ...
                <el-table-column align="right" width="220">
                    <template slot-scope="scope">
                        <el-button @click="initEditPerson(scope.$index, scope.row)" type="primary" size="mini" plain>Editar</el-button>
                        <el-button @click="initShowPerson(scope.$index, scope.row)" type="danger" plain size="mini">Mostrar</el-button>
                    </template>
                </el-table-column>
            </el-table>
