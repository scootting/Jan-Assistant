...
<div>
    <el-card class="box-card">
        <div slot="header" class="clearfix">
            <span>usuarios</span>
            <el-button style="text-align: right; float: right" size="small" type="primary" icon="el-icon-plus" @click="initAddUser">nuevo usuario</el-button>
        </div>
        ...
        <div>
            <el-table v-loading="loading" :data="users" style="width: 100%">
                ...
                <el-table-column align="right" width="280">
                    <template slot-scope="scope">
                        <el-button @click="initEditUser(scope.$index, scope.row)" type="primary" size="mini" plain>Editar</el-button>
                        <el-button @click="initEditUserProfiles(scope.$index, scope.row)" type="danger" plain size="mini">Perfiles</el-button>
                    </template>
                </el-table-column>
            </el-table>
            <el-pagination :page-size="pagination.per_page" layout="prev, pager, next" :current-page="pagination.current_page" :total="pagination.total" @current-change="getDataPageSelected"></el-pagination>
        </div>
    </el-card>
</div>
</template>
...
export default {
    ...
    methods: {
        ...
        initEditUserProfiles(index, row) {
            let personal = row.nro_dip;
            this.$router.push({
