  ...
  <div>
    <el-card class="box-card bg-purple">
      <div slot="header" class="clearfix">
        <span>Documento de Carpintería editado</span>
      </div>
      <div>
    ...
    <el-dialog
      title="Detalle de Entrega de Activo Carpintería"
...
export default {
  ...
  mounted() {
    console.log(
      "Recuperacion de datos desde CapentryDocuments: ",
  ...
  created() {
    var app = this;
    axios
      .post("/api/carpentryDocuments/edit", {
  ...
  methods: {
    test() {
      alert("bienvenido al modulo de documentros de carpintería");
    },
    ...
    Exit() {
      ...
      this.$notify.info({
        ...
        message: "No se hizo cambios al Documento de Carpintería",
        duration: 0
      });
    },
    saveAsset() {
      var app = this;
      axios
        .post("/api/carpentryDocuments/store", this.editForm)
        .then(response => {
