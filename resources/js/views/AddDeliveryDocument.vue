  ...
  <div>
    <el-card class="box-card bg-purple">
      <div slot="header" class="clearfix">
        <span>Nuevo Documento de Compra</span>
      </div>
      <div>
              ...
              <el-row>
                <el-col :span="8" size="small">
                  <el-form-item size="small" label="Responsable" prop="responsable" required>
                    <el-select
                      v-model="encargadoForm.responsable"
                      clearable
                      filterable
                      remote
                      reserve-keyword
                      allow-create
                      placeholder="Introduce Responsable"
                      :remote-method="filterResponsable"
              ...
              <el-row>
                <el-col :span="8" size="small">
                  <el-form-item size="small" label="Cargo Responsable" prop="cargores" required>
                    <el-select
                      v-model="encargadoForm.cargores"
                      filterable
                      allow-create
                      placeholder="Seleccionar cargo del responsable"
                    >
                      <el-option
                        v-for="cargo in cargos"
                        :key="cargo.ff_obtener_cargos"
                        :label="cargo.ff_obtener_cargos"
                        :value="cargo.ff_obtener_cargos"
                      ></el-option>
                    </el-select>
                  </el-form-item>
                </el-col>
        ...
        <el-row>
          <el-col :span="11" size="small">
            <el-form-item size="small" label="Cantidad" prop="cantidad">
              <el-input size="small" v-model="assetForm.cantidad"></el-input>
            </el-form-item>
            <el-form-item size="small" label="Partida" required>
              <el-select size="small" v-model="assetForm.id_partida">
                <el-option
        ...
        <el-row>
          <el-col :span="11" size="small">
            <el-form-item size="small" label="Grupo Contable" required>
              <el-select size="small" v-model="assetForm.id_contable">
                <el-option
            ...
            <el-form-item size="small" label="Vida Util" required>
              <el-input size="small" v-model="assetForm.vida_util"></el-input>
            </el-form-item>
            <el-form-item size="small" label="Precion Unitario" required>
              <el-input size="small" v-model="assetForm.pre_uni"></el-input>
            </el-form-item>
            <el-form-item size="small" label="Nro Factura" prop="nro_fac">
              <el-input size="small" v-model="assetForm.nro_fac"></el-input>
            </el-form-item>
          </el-col>
          <el-col :span="11" size="small">
...
export default {
  ...
  methods: {
    ...
    saveEncargado() {
      var app = this;
      axios
        .post("/api/deliveryDocuments/encargado/add", {
    ...
    saveAsset() {
      ...
      var app = this;
      axios
        .post("/api/deliveryDocuments/asset/add", {
          data: app.assetForm
        })
        .then(response => {
          this.$notify.success({
    ...
    filterResponsable(keyword) {
      if (keyword != "") {
        this.loadingResponsable = true;
        axios
          .get("/api/deliveryDocuments/responsable/" + keyword)
          .then(response => {
    ...
    loadCargos(){
           axios
          .get("/api/deliveryDocuments/cargos/" + this.encargadoForm.responsable)
          .then(response => {
