  ...
  <div>
    <el-card class="box-card bg-purple">
      <div slot="header" class="clearfix">
        <span>Nuevo Documento de Carpintería</span>
      </div>
      <div>
        <el-tabs v-model="selectedTabPane" :tab-position="tabPosition" style="height: 425px;">
          ...
          <el-tab-pane label="Tabla" :disabled="Siguiente" name='tabla'>
           ...
           <el-table-column prop="cantidad" label="Cantidad" width="80"></el-table-column>
        ...
        <el-row>
          ...
          <el-col :span="11" size="small">
            <el-form-item size="small" label="descripcion" prop="descripcion" width="180px">
              <el-input size="small" type="textarea" v-model="assetForm.descripcion" rows="5" max-rows="8"></el-input>
            </el-form-item>
          </el-col>
        </el-row>
        <el-row>
        ...
        <el-row>
          ...
          <el-col :span="11" size="small">
            <el-form-item size="small" label="Descripcion Detallada" prop="descripcion">
              <el-input size="small" type="textarea" v-model="assetForm.des_det" rows="5" max-rows="8"></el-input>
            </el-form-item>
          </el-col>
        </el-row>
        <el-form-item>
...
export default {
  ...
  created() {
    var app = this;
    axios
      .get("/api/carpentryDocuments/getRecursos/" + this.gestion)
      .then(response => {
  ...
  methods: {
    ...
    saveEncargado() {
      var app = this;
      axios
        .post("/api/carpentryDocuments/encargado/add", {
    ...
    saveAsset(){
      ...
      var app = this;
      axios
        .post("/api/carpentryDocuments/asset/add", {
          data: app.assetForm
        })
        .then(response => {
          this.$notify.success({
